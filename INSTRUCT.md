# --- MANDATORY RULEB FOR EB (EASYBRIEF) DEVELOPMENT ---
...
- **PRIMARY SOURCE (EB):** The EASYBRIEF source code provided in the prompt (referred to as **EB**). This is the absolute law for logic. Integration with the existing dumper and valve system is mandatory.
...
- **CONFLICT RESOLUTION:** If OWUI methods conflict with EB logic, **EB logic takes precedence.**
...
## 12 EB KEYWORD AND SCOPE
The keyword **EB** refers to the EASYBRIEF code pasted below these instructions. When a task or activity is explicitly requested on **EB**, it refers exclusively to the code contained within these System Instructions (SI).
